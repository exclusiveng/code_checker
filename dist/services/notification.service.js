...
class NotificationService {
    async send(payload) {
        console.log(`Dispatching notification: ${payload.event} for submission ${payload.submissionId} with status ${payload.status}`);
        ...
        if (!submission || !submission.developer) {
            console.error(`Could not send notification for submission ${payload.submissionId}: submission or developer not found.`);
            return;
        }
